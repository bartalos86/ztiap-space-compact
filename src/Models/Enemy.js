...
export class EnemyBase extends GameObject {
    ...
    setAgression(agression) {
       ...
       // this.agressionCooldown = new Timer((105 - this.agression) * 500);

        //this.fireCooldown = new OnTimer((105 - this.agression) * 500, 500)
        let fireCoolSec = (45 - ((this.agression / 100) * 20)) * 300*5;
        let shotDelay = (35 - ((this.agression / 100) * 10)) * 100;

        let numOfShotsTime = (10 - ((this.agression / 100) * 5)) * shotDelay;

        this.fireCooldown = new OnTimer(fireCoolSec, numOfShotsTime);
        this.agressionCooldown = new Timer(shotDelay);
